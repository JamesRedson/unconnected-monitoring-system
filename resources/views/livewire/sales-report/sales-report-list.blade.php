          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            <div>
              <div class="flex items-center gap-x-3">
                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Sales Report</h2>

                <span class="px-3 py-1 text-xs text-white bg-teal-600 rounded-full">{{ $totalSales }}</span>
              </div>
            ...
            <div class="flex items-center mt-4 gap-x-3">
              ...
              <button wire:click="$dispatch('add-sales-report')"
          ...
          <div>
            ...
            <div class="mt-6 md:flex md:items-center md:justify-between">
              <div class="relative flex items-center mt-4 md:mt-0">
                ...
                <input type="search" placeholder="Search sales report ..." wire:model.live.throttle.250ms="search"
                  autofocus
                        ...
                        @forelse ($salesReports as $salesReport)
                          <tr>
                            ...
                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->pointVoucher->site->name }}
                            </td>

                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->pointVoucher->name }}
                            </td>

                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->voucher_price }}
                            </td>

                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->total_voucher_sales }}
                            </td>

                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->total_amount }}
                            </td>

                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                              {{ $salesReport->reported_at }}
                            </td>
                            ...
                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                              <div class="flex justify-start gap-x-6">
                                ...
                                <div class="flex items-center">
                                  <button
                                    wire:click="$dispatch('edit-sales-report', { salesReport: '{{ $salesReport->id }}' })"
                                    class="inline-flex items-center gap-2 text-gray-500 transition-colors duration-200 dark:hover:text-green-500 dark:text-gray-300 hover:text-green-500 focus:outline-none">
                                ...
                                {{-- delete --}}
                                <button
                                  wire:click="$dispatch('delete-sales-report', { salesReport: '{{ $salesReport->id }}' })"

        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <div>
            <div class="flex items-center gap-x-3">
              ...
              <span class="px-3 py-1 text-xs text-white bg-teal-500 rounded-full">{{ $totalSites }}</span>
            </div>
        ...
        <div>
          ...
          <div class="mt-6 md:flex md:items-center md:justify-between">
            <div class="relative flex items-center mt-4 md:mt-0">
              ...
              <input type="search" placeholder="Search site ..." wire:model.live.throttle.250ms="search" autofocus
                class="block w-full py-1.5 pr-5 text-gray-700 bg-white border border-gray-200 rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-teal-500 dark:focus:border-teal-300 focus:ring-teal-300 focus:outline-none focus:ring focus:ring-opacity-40">
            </div>
          </div>
                          ...
                          <td class="px-4 py-4 text-sm whitespace-nowrap">
                            <div class="flex justify-start gap-x-6">
                              ...
                              <div class="flex items-center">
                                <button wire:click="$dispatch('edit-site',  { site: '{{ $site->id }}' })"
                              ...
                              {{-- delete --}}
                              <button wire:click="$dispatch('delete-site', { site: '{{ $site->id }}' })"
                                class="inline-flex items-center gap-2 text-red-500 dark:text-red-500 transition-colors duration-200 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                  stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
